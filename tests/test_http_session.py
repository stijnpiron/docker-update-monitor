...
class TestCreateHttpSession:
    ...
    def test_returns_session_instance(self):
        session = monitor.create_http_session()
...
class TestSessionIsReused:
    ...
    def test_module_level_session_exists(self):
        assert hasattr(monitor, "http_session")
        assert isinstance(monitor.http_session, requests.Session)
    ...
    def test_dockerhub_login_uses_shared_session(self, mock_session):
        ...
        token = monitor.get_dockerhub_token("user", "pass")
    ...
    def test_fetch_dockerhub_tags_uses_shared_session(self, mock_session):
        ...
        tags = monitor._fetch_dockerhub_tags("library/nginx", "token123")
    ...
    def test_notify_uses_shared_session(self, mock_session):
        ...
        with patch.object(monitor, "NOTIFY_ENDPOINT", "http://hook.example.com"), \
            ...
            monitor.notify([monitor.UpdateInfo(
                container_name="test",
                stack="stack",
                image="nginx",
...
class TestRetryBehavior:
    ...
    def test_429_triggers_retry_on_dockerhub_tags(self, mock_session):
        ...
        tags = monitor._fetch_dockerhub_tags("nginx", None)
    ...
    def test_503_triggers_retry_on_ghcr_tags(self, mock_session):
        ...
        with patch.object(monitor, "_get_ghcr_token", return_value="fake-token"):
            tags = monitor._fetch_ghcr_tags("ghcr.io/owner/repo", "gh-pat")
